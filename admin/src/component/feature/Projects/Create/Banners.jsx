...
const Banners = ({fetchBanners, getBanners, deleteBanners, setDeleteBanners}) => {
                        ...
                        getBanners?.map((value, index) => (
                            <>
                                ...
                                <div className="mb-2 flex-cs w-100 header">
                                    ...
                                    {
                                        deleteBanners && deleteBanners.includes(value && value.s3Key) ? (
                                            <button 
                                                type='button' 
                                                onClick={() => setDeleteBanners(deleteBanners.filter(key => key !== value.s3Key))} 
                                            ...
                                            <button 
                                                type='button' 
                                                onClick={() => setDeleteBanners([...deleteBanners, value.s3Key])} 
                                ...
                                <div key={index} className={`layout ${deleteBanners?.includes(value?.s3Key) && 'fade-cs'}`}>
