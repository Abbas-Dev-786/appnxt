                                        ...
                                        <tbody>
                                            {
                                                projectData?.map((project, index) => (
                                                    <tr key={project._id}>
                                                        ...
                                                        <td>
                                                            <p className="text-xl font-weight-bold mb-0">{project.name}</p>
                                                            <p className="text-xs text-secondary mb-0">{project.type}</p>
                                                        </td>
                                                        <td className="align-middle text-center text-sm">
                                                            <span className="badge badge-sm bg-gradient-success">{project.status}</span>
                                                        </td>
