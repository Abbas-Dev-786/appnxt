...
const Service = () => {
  ...
  return (
    <>
        ...
        <Banner heading={displayData?.heading} content={displayData?.description} bgURL={`/assets/img/service-banner.svg`} />

        <Content heading={displayData?.content?.heading} content={displayData?.content?.description} />
